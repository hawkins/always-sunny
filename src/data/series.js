module.exports = [
  {
    ...
    episodes: [
      ...
      },
      {
        ...
        part: null,
        lead: ["Charlie", "Mac"],
        guest: ["Carmen the Tranny", "The Waitress", "Artemis"],
        writers: ["Rob McElhenney"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Charlie", "Mac"],
        guest: ["Liam McPoyle", "Ryan McPoyle", "Mrs. Kelly"],
        writers: ["Rob McElhenney"],
  ...
  },
  {
    ...
    episodes: [
      ...
      },
      {
        ...
        part: null,
        lead: ["Mac", "Charlie"],
        guest: ["Mrs. Kelly", "Mrs. Mac", "Barbara Reynolds", "The Waitress"],
        writers: ["Charlie Day", "Glenn Howerton"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Frank", "Dennis"],
        guest: ["Rickety Cricket"],
        writers: ["Charlie Day", "Eric Falconer", "Chris Romano"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Charlie", "Dee"],
        guest: ["Artemis", "Liam McPoyle", "Ryan McPoyle"],
        writers: ["Charlie Day", "Rob McElhenney"],
    ...
    episodes: [
      {
        ...
        episode: 1,
        part: null,
        lead: ["Frank", "Dennis", "Charlie"],
        guest: ["Mrs. Kelly", "The Waitress"],
        writers: ["Rob McElhenney", "Charlie Day"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Dee", "Dennis", "Mac"],
        guest: ["Margaret McPoyle", "Ryan McPoyle", "Liam McPoyle", "Artemis"],
        writers: ["Charlie Day", "Glenn Howerton", "David Hornsby"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Dee", "Frank"],
        guest: ["Bruce Mathis", "The Lawyer"],
        writers: ["David Hornsby", "Rob McElhenney"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Frank"],
        guest: ["Margaret McPoyle", "Ryan McPoyle", "Liam McPoyle"],
        writers: ["Lisa Parsons", "Rob McElhenney"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Charlie"],
        writers: ["Charlie Day", "Scott Marder", "Rob Rosell"],
      ...
      },
      {
        ...
        lead: ["Dee", "Charlie"],
        guest: ["The waitress"],
        writers: ["Charlie Day", "David Hornsby"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Dee", "Charlie"],
        writers: ["Glenn Howerton", "Scott Mardery", "Rob Rosell"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Dee", "Dennis", "Mac"],
        guest: ["Carmen the Tranny", "The Waitress", "Mrs. Mac"],
        writers: ["Charlie Day", "David Hornsby"],
      ...
      },
      {
        ...
        episode: 11,
        part: null,
        lead: ["Dennis", "Mac", "Charlie"],
        guest: ["Mrs. Kelly", "Mrs. Mac", "Luther"],
        writers: ["Rob McElhenney"],
      ...
      },
      {
        ...
        episode: 12,
        part: "1 of 2",
        lead: ["Dee", "Dennis", "Mac", "Charlie", "Frank"],
        writers: ["Glenn Howerton", "Scott Marder", "Rob Rosell"],
      ...
      },
      {
        ...
        lead: ["Dee", "Dennis", "Mac", "Charlie", "Frank"],
        guest: ["Rickety Cricket"],
        writers: ["Scott Marder", "Rob Rosell"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Dennis", "Frank"],
        guest: ["The Waitress", "Rickety Cricket"],
        writers: ["Scott Marder", "David Hornsby", "Rob Rosell"],
    ...
    episodes: [
      {
        ...
        episode: 1,
        part: null,
        lead: ["Dee", "Dennis", "Mac", "Charlie"],
        guest: ["Rickety Cricket"],
        writers: ["Charlie Day", "Jordan Young", "Elijah Aron"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Dennis", "Mac", "Charlie"],
        writers: ["Charlie Day", "Sonny Lee", "Patrick Walsh"],
      ...
      },
      {
        ...
        lead: ["Mac", "Frank"],
        guest: ["Rex"],
        writers: ["Charlie Day", "Adam Stein", "Rob McElhenney"],
      ...
      },
      {
        ...
        part: "2 of 2",
        lead: ["Mac", "Charlie"],
        guest: ["Luther", "Mrs. Mac", "Mrs. Kelly"],
        writers: ["Charlie Day", "Glenn Howerton", "Rob McElhenney"],
      ...
      },
      {
        ...
        episode: 7,
        part: null,
        lead: ["Dee", "Dennis", "Mac", "Charlie", "Frank", "Artemis"],
        guest: ["The Waitress", "Rickety Cricket", "Artemis"],
        writers: ["Scott Marder", "Rob Rosell", "Rob McElhenney"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Dee", "Dennis", "Mac", "Frank"],
        writers: ["David Hornsby", "Scott Marder", "Rob Rosell"],
      ...
      },
      {
        ...
        lead: ["Dee", "Dennis", "Mac", "Charlie", "Frank"],
        guest: ["Rickety Cricket"],
        writers: ["Glenn Howerton", "David Hornsby", "Rob McElhenney"],
    ...
    episodes: [
      {
        ...
        lead: ["Dee", "Dennis", "Mac", "Charlie", "Frank"],
        guest: ["The Lawyer"],
        writers: ["Becky Mann", "Audra Sielaff"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Dee", "Dennis", "Mac"],
        guest: ["The Waitress", "Artemis", "Mrs. Mac", "Mrs. Kelly"],
        writers: ["Charlie Day", "Glenn Howerton"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Dennis", "Mac", "Charlie"],
        guest: ["Da Maniac", "Artemis", "Rickety Cricket", "Ben the Soldier"],
        writers: ["Scott Marder", "Rob Rosell"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Dennis"],
        guest: ["The Waitress", "Ben the Soldier"],
        writers: ["David Hornsby", "Scott Marder", "Rob Rosell"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Dennis", "Mac", "Charlie"],
        writers: ["Glenn Howerton", "Rob McElhenney"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Dee", "Dennis", "Mac", "Charlie"],
        guest: ["Mrs. Kelly", "Luther", "Mrs. Mac", "Eugene"],
        writers: ["Charlie Day", "Dave Chernin"],
  ...
  },
  {
    ...
    episodes: [
      ...
      },
      {
        ...
        episode: 4,
        part: null,
        lead: ["Mac", "Charlie", "Frank"],
        guest: ["The Waitress", "Rickety Cricket", "Ben the Soldier"],
        writers: ["Rob Rosell"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Mac", "Charlie"],
        guest: ["Mrs. Mac", "Mrs. Kelly", "Artemis (voice only)"],
        writers: ["Scott Marder", "Rob Rosell"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Dennis", "Mac", "Charlie", "Frank"],
        guest: ["Chase Utley", "Ryan Howard"],
        writers: ["Scott Marder", "Rob Rosell", "Luvh Rakhe"],
      ...
      },
      {
        ...
        writers: ["Davis Hornsby", "Becky Mann", "Audra Sielaff"],
      ...
      },
      {
        ...
        part: "1 & 2 of 2",
        lead: ["Dee", "Dennis", "Mac", "Charlie"],
        guest: ["Eugene", "Luther", "Mrs. Mac", "Mrs. Kelly"],
        writers: [
          "Charlie Day",
          "David Hornsby",
          "Becky Mann",
  ...
  },
  {
    ...
    episodes: [
      ...
      },
      {
        ...
        episode: 4,
        part: null,
        lead: ["Dee", "Mac", "Charlie"],
        writers: ["Charlie Day", "Rob McElhenney", "Glenn Howerton"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Mac", "Charlie"],
        writers: ["Scott Marder", "Mehar Sethi"],
      ...
      },
      {
        ...
        part: "1 of 2",
        lead: ["Dee", "Dennis", "Mac", "Charlie"],
        guest: ["The Waitress", "Rickety Cricket", "Maureen Ponderosa"],
        writers: ["Rob McElhenney", "Glenn Howerton"],
    ...
    episodes: [
      {
        ...
        part: null,
        lead: ["Dee", "Dennis", "Charlie"],
        guest: ["Pop-Pop", "Rickety Cricket", "The Lawyer"],
        writers: ["Charlie Day", "Rob McElhenney", "Glenn Howerton"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Dee", "Charlie"],
        guest: ["The Waitress", "Ruby Taft", "Trevor Taft"],
        writers: ["Charlie Day", "Rob McElhenney", "Glenn Howerton"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Dennis", "Charlie"],
        guest: ["Mrs. Mac", "Mrs. Kelly", "Artemis"],
        writers: ["Rob Rosell", "Scott Marder"],
  ...
  },
  {
    ...
    episodes: [
      ...
      },
      {
        ...
        part: null,
        lead: ["Mac", "Charlie", "Frank"],
        guest: ["The Principal", "Uncle Jack"],
        writers: ["Charlie Day", "Rob McElhenney", "Glenn Howerton"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Dee", "Dennis", "Mac", "Charlie"],
        guest: ["Da Maniac", "Ben the Soldier"],
        writers: ["Dave Chernin", "John Chernin"],
      ...
      },
      {
        ...
        lead: ["Charlie"],
        guest: ["The Waitress"],
        writers: ["David Benloff", "D. B. Weiss"],
  ...
  },
  {
    ...
    episodes: [
      ...
      },
      {
        ...
        part: null,
        lead: ["Dennis", "Mac", "Charlie", "Frank"],
        guest: ["Psycho Pete", "Rickety Cricket"],
        writers: ["Charlie Day", "Rob McElhenney", "Glenn Howerton"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Dennis", "Mac", "Charlie"],
        guest: ["Mrs. Mac", "Mrs. Kelly", "The Master / Rex"],
        writers: ["Scott Marder"],
    ...
    episodes: [
      {
        ...
        part: null,
        lead: ["Frank", "Dennis", "Charlie"],
        guest: ["Andy from 'Matel'", "The Waitress"],
        writers: ["Rob McElhenney", "Charlie Day"],
      ...
      },
      {
        ...
        episode: 3,
        part: null,
        lead: ["Charlie", "Dennis", "Dee", "Mac"],
        guest: ["Drisko", "Roach", "Turkey", "Tatiana"],
        writers: ["Dave Chernin", "John Chernin"],
      ...
      },
      {
        ...
        episode: 4,
        part: null,
        lead: ["Dee", "Charlie", "Dennis"],
        guest: ["Richard Grieco", "Art Gallery Renter", "Rickety Cricket"],
        writers: ["Eric Ledgin"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Dennis", "Mac"],
        guest: ["Wally Schmidt", "'Old Black Man'"],
      ...
      },
      {
        ...
        part: null,
        lead: ["Frank", "Dennis"],
        guest: ["Bill Ponderosa", "The Landlord", "Artemis"],
        writers: ["Scott Marder"],
        title: "Being Frank",
        description:
      ...
      },
      {
        ...
        episode: 8,
        part: null,
        lead: ["Dennis", "Dee", "Charlie"],
        guest: ["The Leprechaun"],
        writers: ["Jon Silberman", "Josh Silberman"],
      ...
      },
      {
        ...
        part: "1 of 2",
        lead: ["Mac", "Dennis"],
        guest: ["The Gay Pastors", "The Young Virgin"],
        writers: ["David Hornsby", "Scott Marder"],
    ...
    episodes: [
      {
        ...
        link: "https://www.hulu.com/watch/1161771"
      },
      {
        season: 12,
        episode: 2,
        part: null,
        lead: ["Dennis", "Charlie", "Frank"],
        guest: ["Abigail"],
        writers: ["Eric Ledgin"],
      ...
      },
      {
        ...
        episode: 3,
        part: null,
        guest: ["Mrs. Kelly", "Mrs. Mac", "Uncle Jack"],
        lead: ["Dennis", "Charlie", "Mac"],
      ...
      },
      {
        ...
        episode: 4,
        part: null,
        guest: ['Donald "Cowboy" Cerrone', "Paul Felder"],
        lead: ["Dennis", "Charlie", "Mac"],
        writers: ["David Hornsby", "Scott Marder"],
